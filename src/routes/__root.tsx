...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Women Care Clinic" },
      { property: "og:title", content: "Women Care Clinic | Women's Healthcare in Peshawar" },
      { property: "og:description", content: "Expert, private and compassionate women's healthcare with Dr. Laila Nazir in Hayatabad, Peshawar." },
